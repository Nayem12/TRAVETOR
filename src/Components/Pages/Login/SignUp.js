      ...
      <div className='md:grid gap-5 w-full mt-5 grid-cols-3 md:px-10 md:w-11/12  mx-auto'>
        ...
        <div className='col-span-1 hidden border border-[#4735e71e] shadow-[#0d057934] shadow-2xl  rounded bg-[#16076149] text-white h-[75vh] p-8 md:flex flex-col gap-16'>
          ...
          <div className='flex flex-col gap-4'>
            <p className='flex items-center gap-2 '><FaGoogle className='text-[#79046f]' /> <span className='text-sm text-slate-400'>shanaeem773@gmail.com</span></p>
            <p className='flex items-center gap-2 '><FaPhoneAlt className='text-[#79046f]' /> <span className='text-sm text-slate-400'>+8801727550571</span></p>
            <p className='flex items-center gap-2 '><FaFirefoxBrowser className='text-[#79046f]' /> <span className='text-sm text-slate-400'>shanaeem773@gmail.com</span></p>
            <p className='flex items-center gap-2 '><FaLocationArrow className='text-[#79046f]' /> <span className='text-sm text-slate-400'>Narayanjang, Bangladesh</span></p>
