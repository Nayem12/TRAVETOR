...
const Header = () => {
  ...
  return (
    <nav className={`header-bg relative z-10 w-full ${backgroundnav ? 'newnavbar ' : 'bg-transparent'} border-b md:border-0  md:static`}>
      <div className="items-center md:justify-between  px-4 max-w-screen-xl mx-auto md:flex md:px-8">
        <div className="flex items-center justify-between py-3 md:py-2 md:block">
          ...
          <div className="md:hidden">
            ...
            outline-none p-2 rounded-md focus:border-gray-400 focus:border"
